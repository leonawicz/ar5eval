...
<p style='text-align:justify;padding-left:20px;padding-right:20px;'>Walsh, J. E., Bhatt, U. S., Littell, J. S., Leonawicz, M., Lindgren, M., Kurkowski, T. A., Bieniek, P.A., Thoman, R., Gray, S., Rupp, T. S. 2018. Downscaling of climate model output for Alaskan stakeholders. Environmental Modelling & Software.</p>
