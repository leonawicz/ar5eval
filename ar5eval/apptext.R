app_intro_title <- "Climate model evalutation results"
app_intro_logo <- "res/snap_white.svg"
app_intro_message <- "<h4>Explore SNAP's AR5/CMIP5 climate model evalutation.</h4>
...
GCM performance is ranked based on minimum error with repsect to a European Re-Analysis (ERA-40) baseline data set using several error metrics.</p>
...
<p style='text-align:justify;'>[add citation]</p>
...
about_app <- tagList(
  ...
  app_citation("Matthew Leonawicz", 2018,
               title = "Web application for Coupled Model Intercomparison Project Phase 5 general circulation model evalutation",
